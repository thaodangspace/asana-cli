...
Write commands are explicit: commenting, updating tasks, and uploading
attachments change remote data. The default test suite uses an in-process HTTP
server and does not require a network connection or real token.
