...
func newRootCommand() *cobra.Command {
	...
	root.AddCommand(
		newMeCommand(),
		newGetUserCommand(),
		newListWorkspaceUsersCommand(),
		newListTeamUsersCommand(),
		newFindUserCommand(),
		newGetTeamCommand(),
		newListWorkspaceTeamsCommand(),
		newListUserTeamsCommand(),
		newListTeamMembershipsCommand(),
		newGetTeamMembershipCommand(),
		newListWorkspaceMembershipsCommand(),
		newListUserWorkspaceMembershipsCommand(),
		newGetWorkspaceMembershipCommand(),
		...
		newListAttachmentsCommand(),
		newGetAttachmentCommand(),
		newDownloadAttachmentCommand(),
		newAddAttachmentCommand(),
		newAddAttachmentURLCommand(),
		newDeleteAttachmentCommand(),
		newCommentOnTaskCommand(),
		newCreateTaskCommand(),
		newUpdateTaskCommand(),
		newDeleteTaskCommand(),
		newDuplicateTaskCommand(),
		newGetCustomFieldCommand(),
		newListWorkspaceCustomFieldsCommand(),
		newCreateCustomFieldCommand(),
		newUpdateCustomFieldCommand(),
		newDeleteCustomFieldCommand(),
		newCreateEnumOptionCommand(),
		newUpdateEnumOptionCommand(),
		newDisableEnumOptionCommand(),
		newReorderEnumOptionCommand(),
		newListCustomFieldSettingsCommand(),
		newAddCustomFieldSettingCommand(),
		newRemoveCustomFieldSettingCommand(),
